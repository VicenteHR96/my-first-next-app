        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <div className="mt-6 flex flex-col gap-4">
            ...
            <button
              type="submit"
              onClick={googleLogin}
              className="flex justify-center items-center gap-2 rounded-md bg-neutral-100 px-3 py-1.5 text-sm font-semibold leading-6 text-gray-600 shadow-sm hover:bg-neutral-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              <GoogleIcon />
              Ingresa con Google
            </button>
